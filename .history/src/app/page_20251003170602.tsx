  ...
  const renderIntro = () => (
    <div className="max-w-6xl mx-auto">
      <div className="bg-white/95 backdrop-blur rounded-2xl shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-yellow-400 to-orange-400 p-4 md:p-8 text-white">
          <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div className="flex-1 order-2 md:order-2 text-center md:text-left">
              <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-white/20 backdrop-blur rounded-full mb-4 md:mb-6">
                <Leaf className="w-8 h-8 md:w-12 md:h-12" />
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-gray-900 leading-tight">Which Strain Flavor Fits Your Vibe?</h1>
